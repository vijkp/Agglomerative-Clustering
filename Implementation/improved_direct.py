...
def main():
    ...
    total_nodes = Ggraph.number_of_nodes()
    ...
    while not bfs_queue.empty():
        ...
        query = Ggraph.neighbors(int(bfs_node))
        for r in query:
    ...
    for i in sortedclusters:
        ...
        if length < minlen:
            minlen = length
        print "Cluster-"+ str(count) + " Total nodes: " + str(length) + " " + str(i)
        count += 1
